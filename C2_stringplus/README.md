...
- Оформить решение как статическую библиотеку (с заголовочным файлом my_string.h)
...
- Предусмотреть Makefile для сборки библиотеки и тестов (с целями all, clean, test, my_string.a, gcov_report)  
...
- Функция должна быть размещена в библиотеке my_string.h.
